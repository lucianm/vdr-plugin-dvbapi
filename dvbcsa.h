...
extern "C" void dvbcsa_key_free(struct dvbcsa_key_s *key);

/** setup a csa key context to use the given control word */

extern "C" void dvbcsa_key_set (const dvbcsa_cw_t cw, struct dvbcsa_key_s *key);

/** decrypt a packet payload */

extern "C" void dvbcsa_decrypt (const struct dvbcsa_key_s *key,
		     unsigned char *data, unsigned int len);

/** encrypt a packet payload */

extern "C" void dvbcsa_encrypt (const struct dvbcsa_key_s *key,
		     unsigned char *data, unsigned int len);
...
extern "C" struct dvbcsa_bs_key_s * dvbcsa_bs_key_alloc(void);

/** free a csa bitslice key context */

extern "C" void dvbcsa_bs_key_free(struct dvbcsa_bs_key_s *key);

/** setup a csa bitslice key context to use the given control word */

extern "C" void dvbcsa_bs_key_set(const dvbcsa_cw_t cw, struct dvbcsa_bs_key_s *key);

/** get maximum number of packet per batch */

extern "C" unsigned int dvbcsa_bs_batch_size(void);
...
extern "C" void dvbcsa_bs_decrypt(const struct dvbcsa_bs_key_s *key,
...
extern "C" void dvbcsa_bs_encrypt(const struct dvbcsa_bs_key_s *key,
		       const struct dvbcsa_bs_batch_s *pcks,
		       unsigned int maxlen);
